...
public class DataScan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textClock = (TextClock) findViewById(R.id.textClock10);
        text_power = (TextView) findViewById(R.id.text_power_10);
        text_user = (TextView) findViewById(R.id.text_user_10);
        text_temp = (TextView) findViewById(R.id.text_temprature10);
        textUp = (TextView) findViewById(R.id.text_up3);
        textDown = (TextView) findViewById(R.id.text_down3);
        textFan = (TextView) findViewById(R.id.text_fan10);
        ...
        Cursor cursor = dbHelper.getReadableDatabase().rawQuery("select * from Data", null);//cursor里必须包含主键"_id"
        inflateList(cursor);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                startActivity(new Intent(DataScan.this, MainActivity.class));
    ...
    private void inflateList(Cursor cursor) {
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(
                ...
                R.layout.item_data,
                cursor,
                new String[]{"_id", "item", "origin", "taking", "left", "datetime", "user", "power"},
                new int[]{
                        R.id.item_id3,
                        R.id.item_liquid3,
                        R.id.item_origin3,
